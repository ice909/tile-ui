...
const META = [
	...
	},
	{
		...
		highlights: ['Five variants', 'Title and description', 'Pairs with Card and Form'],
	...
	},
	{
		...
		highlights: ['Header, media, title, and description', 'Muted and bordered media variants'],
	...
	},
	{
		...
		intro: 'Use Marker to tag content with a colored status.',
		highlights: ['Five color variants', 'Icon and content', '`asChild` support'],
		usage: '<Marker variant="green">\n\t<MarkerIcon />\n\t<MarkerContent>Online</MarkerContent>\n</Marker>',
	...
	},
	{
		...
		highlights: ['Media, content, and actions', 'Group and separator', 'Three variants'],
	...
	},
	{
		...
		highlights: ['Three variants', 'Four sizes', 'Text and separator'],
		usage: '<ButtonGroup>\n\t<Button>One</Button>\n\t<Button>Two</Button>\n\t<Button>Three</Button>\n</ButtonGroup>',
