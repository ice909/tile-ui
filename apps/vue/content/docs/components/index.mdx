---
title: Components
description: Reference for the core Vue component primitives available in Tile UI.
---

Tile UI Vue ships a complete set of foundational UI primitives, all available through the Vue registry. Every component below has a dedicated reference page.
