...
export const vueDemoRegistry: Record<string, VueDemo> = {
	badge: {
	...
	'use-copy-to-clipboard': {
		...
		description: 'Copies the registry URL while the composable manages the transient "copied" feedback state.',
