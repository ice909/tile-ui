...
The Solid registry contains 61 UI items. Every item has an interactive demo, a dedicated API reference, and support for client rendering, server rendering, and static generation.
