...
The manifest contains exactly 70 independently installable items: 62 UI components, 3 primitive hooks, and 5 shared items for core logic, Liveline's source-preserving engine, utility helpers, styles, and the default theme.
