...
export default function LivelineDemo() {
	...
	return (
		<section className="ll-demo" data-theme={theme} style={{ marginBottom: 24 }} aria-label={`${'Live line'} demo`}>
			...
			<div className="ll-controls" role="group" aria-label={`${'Live line'} feed state`}>
				<span>State</span>
			...
			<div className="ll-controls" role="group" aria-label={`${'Live line'} volatility`}>
			...
			<div className="ll-controls" role="group" aria-label={`${'Live line'} cadence`}>
				<span>Tick rate</span>
			...
			<div className="ll-controls" role="group" aria-label={`${'Live line'} features`}>
				<span>Features</span>
			...
			<div className="ll-controls" role="group" aria-label={`${'Live line'} window style`}>
				<span>Window</span>
...

			{
				<div className="ll-panel">
					<Liveline
						{...common}
						aria-label={`${'Live line'}: ${state}, ${paused ? 'paused' : 'running'}, ${formatDemoPrice(value)}`}
						data={data}
						value={value}
						mode={'line'}
						windows={windows}
